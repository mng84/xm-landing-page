    ...
    return (
        <section className="p-[20px] max-w-[1200px] mx-auto">
            ...
            <div className="py-[20px] px-[15px] grid grid-cols-12 gap-x-6 gap-y-5">
                <div className="col-span-12 row-span-3 bg-[#0B0819] px-[40px] py-[60px] rounded-[10px] flex md:justify-between lg:flex-col lg:col-span-4 lg:row-span-12">
                    <div>
                    ...
                    <img src={fastExecutionIcon} className="w-[200px]" alt="Superior Trade Execution" />
                </div>
                ...
                <div className="col-span-12 row-span-3 bg-[#0B0819] px-[40px] py-[60px] rounded-[10px] lg:col-span-8 lg:row-span-6">
                    <div className="flex flex-col relative">
                        <div>
                            ...
                            <div className="w-[50px] h-[2px] bg-[--xm-green] my-[30px]"></div>
                            <img src={competitivePricingIcon} className="absolute top-[-20px] right-[0px] w-[100px]" alt="Competitive Trade Execution" />
                        </div>
                ...
                <div className="col-span-12 row-span-3 bg-[#0B0819] px-[40px] py-[60px] rounded-[10px] lg:col-span-4 lg:row-span-6">
                    ...
                    <div className="flex justify-between items-start relative">
                        <div>
                            ...
                            <div className="w-[50px] h-[2px] bg-[--xm-green] my-[30px]"></div>
                            <img src={techIcon} className="absolute top-[-20px] right-[0px] w-[80px]" alt="Advance Technology" />
                        </div>
                    </div>
                ...
                <div className="col-span-12 row-span-3 bg-[#0B0819] px-[40px] py-[60px] rounded-[10px] lg:col-span-4 lg:row-span-6">
                    <div className="flex justify-between items-start relative">
                        <div>
                            ...
                            <div className="w-[50px] h-[2px] bg-[--xm-green] my-[30px]"></div>
                            <img src={dolarIcon} className="absolute top-[-20px] right-[0px] w-[80px]" alt="Start with $5" />
                        </div>
                    </div>
