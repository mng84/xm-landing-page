            ...
            <div className="max-w-[1200px] mx-auto">
                <div className="py-[20px] px-[15px] grid grid-cols-12 lg:gap-x-10 gap-y-10">
                    ...
                    <div className="col-span-12 row-span-3 text-center md:text-left md:col-span-6 lg:col-span-4 lg:row-span-3">
                        ...
                        <p className="w-full text-[14px] leading-[20px] font-[400] lg:text-[14px] lg:leading-[21px] md:w-[220px]">At XM, we adhere to all regulatory standards and are fully authorised and regulated by FSC.</p>
                    </div>
                    <div className="col-span-12 row-span-3 text-center md:text-left md:col-span-6 lg:col-span-4 lg:row-span-3">
                        ...
                        <p className="w-full text-[14px] leading-[20px] font-[400] lg:text-[14px] lg:leading-[21px] md:w-[220px]">Over the years we have received over 40 awards for the quality of our products and services.</p>
                    </div>
                    <div className="col-span-12 row-span-3 text-center md:text-left md:col-span-6 lg:col-span-4 lg:row-span-3">
                        ...
                        <p className="w-full text-[14px] leading-[20px] font-[400] lg:text-[14px] lg:leading-[21px] md:w-[220px]">We operate with complete transparency and adhere to the highest professional and ethical standards.</p>
                    </div>
                    <div className="col-span-12 row-span-3 text-center md:text-left md:col-span-6 lg:col-span-4 lg:row-span-3">
                        ...
                        <p className="w-full text-[14px] leading-[20px] font-[400] lg:text-[14px] lg:leading-[21px] md:w-[220px]">Our support agents are on hand 24/7 to answer your questions or assist you with any issues.</p>
                    </div>
                </div>
            </div>
        </section>
