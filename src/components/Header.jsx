    ...
    <header className="w-full">
      ...
      <div className="flex flex-col items-center text-center pt-[80px] max-w-[1200px] mx-auto">
        <div className="max-w-[650px]">
          ...
          <a href="https://www.xm.com/register/profile-account?lang=en" target="_blank" rel="noopener noreferrer" className="c-button w-[90%] mx-auto block p-[20px] text-[#FFFFFF] text-[24px] text-center font-[700] mb-[30px] bg-[--xm-green]">OPEN ACCOUNT</a>
