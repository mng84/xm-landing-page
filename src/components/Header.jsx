    ...
    <header className="w-full">
      ...
      <div className="flex flex-col items-center text-center pt-[80px] max-w-[1200px] mx-auto">
        <div className="max-w-[650px]">
          ...
          <a href="https://www.xm.com/register/profile-account?lang=en" target="_blank" rel="noopener noreferrer" className="c-button-font w-[80%] mx-auto block p-[5px] text-[rgb(255,255,255)] text-[24px] text-center font-[700] mb-[30px] bg-[--xm-green] lg:w-[60%] lg:mx-auto">OPEN ACCOUNT</a>
